...
export function ProductDetailsPage() {
  ...
  return (
    <div className='fram'>
      <iframe width="100%" height="550px" src={product.video} title="KR$NA - I Guess | Official Music Video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <div>
        <div className="movie-specs">
          <h2 className="movie-name">{product.title} - {productid}

          </h2>

          <h3 className="movie-rating">{product.subheader}</h3>
        </div>
        <p className="movie-summary">{product.About}</p>
      </div>
      <Button
        onClick={() => navigate(-1)}
...
//<iframe width="898" height="505" src="https://www.youtube.com/embed/cstaHbq5fZ4" title="Mediterranean Diet 101" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>